...
export interface VaultUser {
  isLoading: boolean
  userShares: string
  adeAtLastUserAction: string
  lastDepositedTime: string
  lastUserActionTime: string
}
export interface AdeVault {
  totalShares?: string
  pricePerFullShare?: string
  totalAdeInVault?: string
  estimatedAdeBountyReward?: string
  totalPendingAdeHarvest?: string
  fees?: VaultFees
  userData?: VaultUser
}
