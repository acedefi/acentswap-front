import { ONE_DAY_UNIX, ADE_FINANCE_START } from 'config/constants/info'
import { getUnixTime } from 'date-fns'
import { TransactionType } from 'state/info/types'
import { ChartEntry } from '../types'
import { MintResponse, SwapResponse, BurnResponse, TokenDayData, PairDayData, AdeDayData } from './types'
...
export const mapDayData = (tokenDayData: TokenDayData | AdeDayData): ChartEntry => ({
...
export const fetchChartData = async (
  ...
  let timestamp = firstAvailableDayData?.date ?? ADE_FINANCE_START
