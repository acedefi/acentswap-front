...
const fetchFarm = async (farm: SerializedFarm): Promise<PublicFarmData> => {
  ...
  // const quoteTokenAmountTotal = new BigNumber(quoteToken.symbol === 'WACE' ? new BigNumber(1000000000000000000) : quoteTokenBalanceLP).div(BIG_TEN.pow(quoteTokenDecimals)) // FIXME debug hard code for farms
