...
import { formatAce, formatUsd, getMultiplier, getPayout } from 'views/Predictions/components/History/helpers'
...
describe('formatBnb', () => {
  it.each([
    ...
    expect(formatAce(value)).toEqual(expected)
  })

  it('returns 0 if BNB is undefined', () => {
    expect(formatAce(undefined)).toEqual('0')
  })
})
