...
import { formatRoundTime, padTime, formatAcev2, formatUsdv2 } from 'views/Predictions/helpers'
...
describe('formatBnbv2', () => {
  ...
  `(
    'should format $priceDifference to $expectedPriceDifferenceFormatted',
    ({ priceDifference, expectedPriceDifferenceFormatted }) =>
      expect(formatAcev2(BigNumber.from(priceDifference))).toEqual(expectedPriceDifferenceFormatted),
  )
})
