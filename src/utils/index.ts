...
import { ChainId, JSBI, Percent, Token, CurrencyAmount, Currency, ETHER } from '@acentswap/ade-sdk-trial'
...
// show adePrice
export function showAdePrice(): boolean {
  return process.env.REACT_APP_SHOW_ADE_PRICE === 'true'
}
...
export function getExplorerLink( // FIXME change to acent explorer
  data: string | number,
...
export function calculateGasMargin(value: BigNumber): BigNumber {
  ...
  console.log(value,"THISISVALUETHISISVALUE");
