...
import sousChefAce from 'config/abi/sousChefAce.json'
...
export const getSouschefContract = (id: number, signer?: ethers.Signer | ethers.providers.Provider) => {
  ...
  const abi = config.poolCategory === PoolCategory.BINANCE ? sousChefAce : sousChef
...
export const getAdeContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(adeAbi, tokens.ade.address, signer)
}
...
export const getAdeVaultContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(adeVaultAbi, getAdeVaultAddress(), signer)
}
