...
export const BASE_URL = 'https://acentswap.acent.tech'
// export const BASE_EXPLORER_URL = 'https://acent.crypto.org/explorer'

export const ADE_FINANCE_START = 1636354800 // FIXME start time
