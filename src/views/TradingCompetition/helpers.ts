...
export const useCompetitionCakeRewards = (userCakeReward: ReactText) => {
  ...
  const acePriceUsdc = usePriceAdeUsdc()
  return {
    cakeReward: cakeBalance,
    dollarValueOfCakeReward: acePriceUsdc.gt(0) ? cakeBalance * acePriceUsdc.toNumber() : null,
  }
}
...
// Achievement keys are consistent aacess different teams regardless of team team rank
