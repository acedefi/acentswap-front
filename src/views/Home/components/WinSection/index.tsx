...
import { Flex, Text, TicketFillIcon, PredictionsIcon } from '@acentswap/ace-uikit'
...
const bottomLeftImage = {
  ...
  attributes: [
    { src: 'bottom-left', alt: 'ADE card' },
    { src: 'green', alt: 'Green ADE card with up arrow' },
    { src: 'red', alt: 'Red ADE card with down arrow' },
    { src: 'top-right', alt: 'ADE card' },
  ],
}
