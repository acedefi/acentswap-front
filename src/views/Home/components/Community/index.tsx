...
import { Flex, Text, Image, useMatchBreakpoints, Link } from '@acentswap/ace-uikit'
...
const socialMediaData = [
  {
    src: `${process.env.PUBLIC_URL}/images/home/community/twitter.svg`,
    url: 'https://bit.ly/2UCSX3b'
  },
  {
    src: `${process.env.PUBLIC_URL}/images/home/community/medium.svg`,
    url: 'https://medium.com/acent-tech'
  },
  {
    src: `${process.env.PUBLIC_URL}/images/home/community/shape.svg`,
    url: 'https://t.me/AcentChannel'
  },
]
...
const Community = () => {
  ...
  return (
    <Flex alignContent="center" flexDirection="column" justifyContent="center" id="Community">
      ...
      >
        We are the best a group of DeFi enthusiasts who desire to build a platform our peers will use and love. So join the chat, and you can bet we will keep our ears wide open!
      </Text>
      <GradientsFont
        {...FontStyle}
        textAlign="center"
