...
import { Flex, Image, Link, Button, Text, useMatchBreakpoints } from '@acentswap/ace-uikit'
...
const imagePath = `${process.env.PUBLIC_URL}/images/home/lunar-bunny/`
const imageSrc = 'bunny'

const starsImage: CompositeImageProps = {
  path: `${process.env.PUBLIC_URL}/images/home/lunar-bunny/`,
  attributes: [
    { src: 'star-l', 
      alt: '3D Star',  
      coordination: {
    ...
    { src: 'main', alt: 'bunny' },
    { src: 'star-top-r', alt: '3D Star', coordination: {
      width: '26px',
      height: '26px',
      top: '64%',
      left: '78%',
...
const mobileDiamonds: CompositeImageProps = {
  path: `${process.env.PUBLIC_URL}/images/home/landing-page/`,
  attributes: [
    // {
    //   src: 'diamond2',
    //   alt: 'diamond2',
    ...
    <>
      ...
      <HeroContainer position="relative" justifyContent="center" id="homepage-hero" minHeight="358px">
        <Flex flex="1" flexDirection="column" maxWidth="512px" mt={["40px", "40px", "40px", "80px"]}>
          <StyledBigHeading>ACENT Finance Best DeFi Trading For All</StyledBigHeading>
          <Text {...titleStyleProps} color="white">
            Your gateway to the decentralized finance movement. Take control of your finances and earn sparkly ADE
            rewards.
          </Text>
          <Text {...titleStyleProps} color="white">
            <Link mr="5px" href="https://docs.acentswap.acent.tech" target="_blank" display="inline-block" {...titleStyleProps}>
              Learn more
            </Link>
            about acentswap.acent.tech.
          </Text>
          {
