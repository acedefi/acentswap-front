...
import { Flex, Text, useMatchBreakpoints,Svg } from '@acentswap/ace-uikit'
...
const imagesInfos = [
  {
    ...
    height: 144,
    subTitle:
      'Streams of passive income to multiply your assets. The rarest and brightest yield farming in the ADE farms.',
  },
  {
...
const bgTriangle: CompositeImageProps = {
  path: `${process.env.PUBLIC_URL}/images/home/defi-section/`,
  attributes: [
    // {
    //   src: 'triangle',
    //   alt: 'triangle',
...
const Flower = () => {
  return (
    <FlowerWrapper width="162px" height="144px" flexDirection="column">
      <Flex>
        {/* <ImageWrapper
          src={`${process.env.PUBLIC_URL}/images/home/lorem/leaf-L.svg`}
          className="left-leaf"
          maxHeight="100px"
          alt="leaf-l"
          width="80px"
        ...
        <ImageWrapper
          ...
          height="100px"
          top="-10px"
          src={`${process.env.PUBLIC_URL}/images/home/lorem/leaf-R.svg`}
          maxHeight="100px"
          alt="leaf-r"
        /> */}
      </Flex>
      <ImageWrapper
        ...
        height="300px"
        top="0px"
        src={`${process.env.PUBLIC_URL}/images/sprout.png`} 
        maxHeight="420px" 
        alt="leaf-r"
       />
    </FlowerWrapper>
  ...
  return (
    <FlyCoinWrapper width="162px" height="144px" flexDirection="column" position="relative">
      {/* <ImageWrapper
        ...
        maxHeight="75px"
      /> */}
      <ImageWrapper src={`${process.env.PUBLIC_URL}/images/home/cake/coin@2x.png`} top="-10px" alt="coin" width="200px" height="200px" />
      {/* <ImageWrapper
...
const ShieldWrapper = () => {
  return (
    <Flex position="relative" width="300px">
      <ImageWrapper src={`${process.env.PUBLIC_URL}/images/home/earn/folder@2x.png`} height="400px" alt="shield" maxHeight="500px" top="-125px"/>
  ...
  return (
    <>
      ...
      <Flex justifyContent="center" alignItems="center" flexDirection="column">
        <TitleWrapper>
          We aim to make DeFi faster and within reach of billions. Low fees, fast transactions, and competitive
          earnings.
        </TitleWrapper>
