...
import { Currency, currencyEquals, ETHER, Percent, WETH } from '@acentswap/ade-sdk-trial'
import { Button, Text, AddIcon, ArrowDownIcon, CardBody, Slider, Box, Flex, useModal } from '@acentswap/ace-uikit'
                  ...
                  {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                    <RowBetween style={{ justifyContent: 'flex-end', fontSize: '14px' }}>
                      {oneCurrencyIsETH ? (
                        ...
                        <StyledInternalLink
                          to={`/remove/${currencyA && currencyEquals(currencyA, WETH[chainId]) ? 'ACE' : currencyIdA}/${
                            currencyB && currencyEquals(currencyB, WETH[chainId]) ? 'ACE' : currencyIdB
                          }`}
                        >
                          {t('Receive ACE')}
                        </StyledInternalLink>
