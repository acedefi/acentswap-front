...
const MIN_PRICE_ACE_DISPLAYED = BigNumber.from('1000000000000000')
...
export const formatAcev2 = (ace: BigNumber) => {
  return formatPriceDifference({ price: ace, minPriceDisplayed: MIN_PRICE_ACE_DISPLAYED, unitPrefix: '', decimals: 18 })
}
