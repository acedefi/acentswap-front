...
import { Box, ChevronDownIcon, ChevronUpIcon, Flex, IconButton, PlayCircleOutlineIcon, Text, WaitIcon } from '@acentswap/ace-uikit'
    ...
    return (
      <>
        ...
        <Text bold color={resultTextColor} lineHeight={1}>
          {roundResult === Result.CANCELED ? t('Canceled') : `${resultTextPrefix}${formatAce(payout)}`}
        </Text>
      </>
    )
  }
