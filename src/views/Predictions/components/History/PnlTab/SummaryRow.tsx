...
import { Price } from '@acentswap/ade-sdk-trial'
import { Flex, Text } from '@acentswap/ace-uikit'
import { multiplyPriceByAmount } from 'utils/prices'
import { useTranslation } from 'contexts/Localization'
import { formatAce } from '../helpers'
...
const SummaryRow: React.FC<SummaryRowProps> = ({ type, summary, aceUsdcPrice }) => {
  ...
  const amountInUsd = multiplyPriceByAmount(aceUsdcPrice, displayAmount)
    ...
    <>
      ...
      <Flex>
        ...
        <Flex flex="3" flexDirection="column">
          <Text bold fontSize="20px" color={color}>
            {`${summaryTypeSigns[type]}${formatAce(displayAmount)} ACE`}
          </Text>
          <Text fontSize="12px" color="textSubtle">
