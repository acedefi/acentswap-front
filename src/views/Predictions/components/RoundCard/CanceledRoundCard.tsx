...
import { Card, CardBody, Text, Flex, BlockIcon, LinkExternal } from '@acentswap/ace-uikit'
      ...
      <CardBody p="16px">
        ...
        <RoundResultBox>
          <Flex flexDirection="column" alignItems="center">
            ...
            <LinkExternal href="https://docs.acentswap.acent.tech/products/prediction" external>
              {t('Learn More')}
            </LinkExternal>
          </Flex>
        </RoundResultBox>
