...
import { Card, CardBody, PlayCircleOutlineIcon, Button, useTooltip, ArrowUpIcon, ArrowDownIcon } from '@acentswap/ace-uikit'
...
const OpenRoundCard: React.FC<OpenRoundCardProps> = ({
  ...
  const { targetRef, tooltipVisible, tooltip } = useTooltip(
    <div style={{ whiteSpace: 'nowrap' }}>{`${formatAcev2(betAmount)} ACE`}</div>,
    { placement: 'top' },
  )
