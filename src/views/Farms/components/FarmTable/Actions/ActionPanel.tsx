...
import { LinkExternal, Text } from '@acentswap/ace-uikit'
...
import AdeAllocation, { AllocationProps } from '../AdeAllocation'
  ...
  return (
    <Container expanded={expanded} background="#F4F5F1">
      ...
      <ValueContainer>
        {isBlindMode() ? (
          <ValueWrapper>
            <Text color="textSubtle">{t('ADE Allocation')}</Text>
            <AdeAllocation {...allocation} />
          </ValueWrapper>
        ) : (<ValueWrapper>
