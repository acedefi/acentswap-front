...
import { Skeleton, Text, useTooltip, HelpIcon, Flex, Box, useMatchBreakpoints } from '@acentswap/ace-uikit'
...
const AutoEarningsCell: React.FC<AutoEarningsCellProps> = ({ pool, account, userDataLoaded }) => {
  ...
  const labelText = t('Recent ADE profit')
  const earningTokenBalance = autoAdeToDisplay
  ...
  const { targetRef, tooltip, tooltipVisible } = useTooltip(
    <>
      <Balance fontSize="16px" value={autoAdeToDisplay} decimals={3} bold unit=" ADE" />
